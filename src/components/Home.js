    ...
    <section className="contents">
      <section className="left-col">
        ...
        <div className="home-para">
          ...
          <a id="emailMe" href="mailto:marcus.loy.77@gmail.com"><div className='emailBtn'>  <div className='icon homeMail'><MdEmail/></div> <span className='emailBtnText'> Email</span></div></a>
        </div>
